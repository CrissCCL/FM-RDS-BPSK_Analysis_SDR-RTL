...
-  **figuras_rds_A** → main figures generated by Part A
-  **docs/results** → real capture logs and Part B summary figure
-  **docs/latex** → LaTeX/TikZ source for the processing pipeline diagram
