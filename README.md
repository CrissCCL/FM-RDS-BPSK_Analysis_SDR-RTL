...
-  **src** → Python code for SDR capture, demodulation, and RDS decoding
-  **results** → real capture logs and Part B summary figure
...
## ✅ Real Capture Results: Radio Carolina 98.9 MHz
...
### 🧪 Part A: RDS Extraction and BPSK Validation
...
<p align="center">
<img src="https://github.com/user-attachments/assets/07b9eab8-27b2-4126-922d-a2b9d7e4967b" alt="Part B RDS summary for Radio Carolina 98.9 MHz" width="500">
</p>
